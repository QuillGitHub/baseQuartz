...
/**
 * @author Yingjie Qi
 * @create 2018-05-14 15:47
 **/

public class SixScheduler {
    ...
    public static void main(String[] args) throws SchedulerException {
        ...
        JobDetail jobDeatil = JobBuilder.newJob(SixJob.class)
        ...
        Trigger trigger = TriggerBuilder.newTrigger()
                ...
                .startAt(date)// 定义3秒后执行  开始时间StartTime
                .endAt(endDate)// 定义6秒后结束  结束时间endTime
